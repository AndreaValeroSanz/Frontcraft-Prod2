...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [AppPlayersComponentPipes, HeroComponent, PlayersModule, RouterOutlet, FullscreenModalComponent, PlayersComponent, NavBarComponent, ListComponentComponent],
